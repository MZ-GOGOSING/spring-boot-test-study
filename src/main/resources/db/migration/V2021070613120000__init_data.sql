...
VALUES (1, '첫번째 게시물 제목', false, current_timestamp(), current_timestamp());

INSERT INTO board (board_id, board_title, board_use_yn, create_date, update_date)
VALUES (2, '두번째 게시물 제목', false, current_timestamp(), current_timestamp());

INSERT INTO board (board_id, board_title, board_use_yn, create_date, update_date)
VALUES (3, '세번째 게시물 제목', false, current_timestamp(), current_timestamp());

INSERT INTO board (board_id, board_title, board_use_yn, create_date, update_date)
VALUES (4, '네번째 게시물 제목', false, current_timestamp(), current_timestamp());

INSERT INTO board (board_id, board_title, board_use_yn, create_date, update_date)
VALUES (5, '다섯번째 게시물 제목', false, current_timestamp(), current_timestamp());
